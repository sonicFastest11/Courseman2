...
CREATE TABLE `enrolment` (
  ...
  KEY `FKoge163yb6vs7705i7y0akb7y7` (`userid`),
  ...
  CONSTRAINT `FKoge163yb6vs7705i7y0akb7y7` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
...
INSERT INTO `enrolment` VALUES (25,64,5),(26,64,14),(28,62,5),(29,62,14),(35,62,18),(38,62,17),(39,62,21);
